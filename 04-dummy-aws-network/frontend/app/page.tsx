...
export default function HomePage() {
  ...
  async function load() {
    try {
      ...
      setHealth("fail");
      setError("Nginx 또는 백엔드에 연결하지 못했습니다. 80 포트와 README를 확인하세요.");
    }
  }
  ...
  return (
    <main className="wrap">
      <div className="badge">Dummy Project · AWS Network 담당용</div>
      <h1>StudyBoard</h1>
      <p className="lead">
        Docker, Nginx, EC2 배포까지 가능한 더미입니다. VPC / Security Group /
        ALB 구성은 아직 없습니다. 당신이 연결합니다.
      </p>
